...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        genes = genefinder(person, one_gene, two_genes)
        boolval = person in have_trait

        if mother is None and father is None:
            gene_prob = PROBS['gene'][genes]
        else:
            mother_genes = genefinder(mother, one_gene, two_genes)
            father_genes = genefinder(father, one_gene, two_genes)
...
def genefinder(person, one_gene, two_genes):
...
def update(probabilities, one_gene, two_genes, have_trait, p):
    ...
    for person in probabilities:
        person_genes = genefinder(person, one_gene, two_genes)
...
def normalize(probabilities):
    ...
    for person in probabilities:
        trait_ratio = 1 / (probabilities[person]['trait'][True] + probabilities[person]['trait'][False])
        ...
        gene_ratio = 1 / (
                ...
                0])
        probabilities[person]['gene'][2] *= gene_ratio
        probabilities[person]['gene'][1] *= gene_ratio
        probabilities[person]['gene'][0] *= gene_ratio
    return
